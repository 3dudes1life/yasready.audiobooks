...
async function identity() {
  ...
  console.log(JSON.stringify({
    ...
    sourceSectionCount: identity.sourceSectionCount,
    narrativeChapterCount: identity.narrativeChapterCount,
    excludedNonNarrativeSectionCount: identity.excludedNonNarrativeSectionCount,
    excludedNonNarrativeSections: identity.excludedNonNarrativeSections,
