...
export const BOOK_ONE_VOICE_DEPTH_ACCEPTED_PILOT_RELEASES = Object.freeze(['0.14.3.14.1', '0.14.3.14.2', '0.14.3.15', '0.14.3.16', '0.14.3.17', '0.14.3.18', '0.14.3.18.1', '0.14.3.18.2', '0.14.3.19', '0.14.3.20', '0.14.3.20.1', '0.14.3.20.2', '0.14.3.20.3', '0.14.3.20.4', '0.14.3.20.5']);
...
export function renderBookOneVoiceDepthReviewHtml(calibration) {
  ...
  return withYasReadyPlatformUI(`<!doctype html><html><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>Book One Voice Depth Calibration</title>
