...
export function renderBookOnePauseDeficitAuditHtml(audit) {
  ...
  const s = audit.summary;
  return withYasReadyPlatformUI(`<!doctype html><html><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>Book One — Pause Localization & Deficit Audit</title><style>
