...
export function renderBookOneHumanPauseReviewHtml({ audit, previewManifest, serverMode = false } = {}) {
  ...
  return withYasReadyPlatformUI(`<!doctype html><html><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>YasReady — Human Pause Review</title><style>
